 ...
 */
public class ConstraintRelevanceFinder {
	private static MessagePrinter logger = MessagePrinter.getInstance(ConstraintRelevanceFinder.class);
	 ...
	 */
	public ConstraintRelevanceFinder(TaskCharEncoderDecoder taChaEncoDeco, Constraint... constraints) {
	 ...
	 * @param constraints Constraints to be evaluated
	 */
	public ConstraintRelevanceFinder(Constraint... constraints) {
	 ...
	 */
	public ConstraintRelevanceFinder(TaskCharEncoderDecoder taChaEncoDeco, TaskCharArchive tCharArchive, Collection<Constraint> parametricConstraints) {
