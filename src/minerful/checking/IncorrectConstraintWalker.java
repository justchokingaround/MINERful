...
@Deprecated
public class IncorrectConstraintWalker {
	private static MessagePrinter logger = MessagePrinter.getInstance(IncorrectConstraintWalker.class);
	...
	public IncorrectConstraintWalker(Constraint cns) {
		this.cns = cns;
	...
	public static void main(String[] args) {
		...
		IncorrectConstraintWalker evalu = new IncorrectConstraintWalker(
				new Succession(
